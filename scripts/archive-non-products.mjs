...
let BLOCKLIST = new Set([
  ...
  // Newly archived (manual blocklist 2025-10-08)
  'assistant-ui','claude-coder','cline','comp','diffusers','flycut-caption','gateway','mmaction2','mmagic','MONAI','nacos','react-native-gifted-chat','sim','stagehand','text-generation-webui','transformers','Vosk','woodpecker','Zero','Context-Engineering','gpt-2','LLMs-from-scratch','Text2Video-Zero','TradingAgents','Tune-A-Video','vid2avatar','deeplake','qdrant'
]);
