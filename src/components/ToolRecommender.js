<!-- Add this inside the <body> tag, below the existing modal -->
<div id="prompt-modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <form id="prompt-form" class="space-y-4">
            <input type="text" id="basic-prompt-input" placeholder="Enter a basic prompt..." class="w-full p-3 rounded-md bg-secondary border-color text-primary focus:outline-none focus:ring-2 focus:ring-purple-500" required>
        ...
        <div id="recommended-tool" class="mt-4 text-primary"></div>
    </div>
</div>